...
description: "This project uses Microeconomic time series data to evaluate ARIMA, Holt’s Winter, STLF, and TBATS models, aiming to find the best method for profit prediction and financial planning."
